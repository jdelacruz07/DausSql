...
//		Player player2 = new Player(); 
		...
		jdbcTemplate.query("SELECT * FROM player where id_player = ?", new Object[] { id },
...
//   			).forEach(player -> System.out.println(player));
	...
	private void throwDice(String isThrow, int idPlayer, String name) {
		...
		if (isThrow.equals("y")) {
			...
			jdbcTemplate.update("INSERT INTO play(dice_One, dice_Two, is_Win, id_player) VALUES (?,?,?,?)", diceOne,
					diceTwo, isWin, idPlayer);
		}
